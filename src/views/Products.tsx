...
export async function action({request} : ActionFunctionArgs) {    //extrae el valor : dse la url, en este caso id
  const data = Object.fromEntries(await request.formData())   //Obtenemos los datos del form
